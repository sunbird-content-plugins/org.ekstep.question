  ...
  .controller('QuestionCreationFormController', ['$scope', 'instance', 'questionData', function($scope, instance, questionData) {
    ...
    $scope.showQuestionForm = function(qData) {
      ...
      /*  $scope.questionData.medium = questionData1.data.config.metadata.medium;
        $scope.questionData.title = questionData1.data.config.metadata.title;
        $scope.questionData.qlevel = questionData1.data.config.metadata.qlevel;*/
      $scope.questionData.medium = questionData1.data.config.metadata.medium;
      $scope.questionData.title = questionData.title;
      $scope.questionData.qlevel = questionData.qlevel;
